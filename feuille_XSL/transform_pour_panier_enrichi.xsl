        ...
        <xsl:result-document href="output/index.html" method="html">
            <html>
                <head>
                    ...
                    <script type="text/javascript" src="statics/js/logo.js"></script>
                </head>
                <body>
                    <header>
                        ...
                        <div class="header-content">
                            <h1>Base de données PHILIDOR4</h1>
                            <h2>Edition numérique</h2>
                        </div>
                    </header>
                                ...
                                <xsl:for-each select="//item[generate-id(.) = generate-id(key('projects', projet)[1])]">
                                    ...
                                    <li>
                                        <a href="projects/{translate(projet, ' ', '_')}.html">
                                            <xsl:value-of select="//projet_info[@id = current()/projet]/nom_projet"/>
                                        </a>
                ...
                <body>
                    ...
                    <main>
                        <section class="project-content">
                            <h2><xsl:value-of select="//projet_info[@id = current()/projet]/nom_projet"/></h2>

                            <xsl:copy-of select="//projet_info[@id = current()/projet]/descr_projet/node()"/>
                ...
                <html>
                    ...
                    <body>
                        ...
                        <nav>
                            ...
                            <a href="../projects/{translate(projet, ' ', '_')}.html">Projet <xsl:value-of select="projet"/></a>
                        </nav>
